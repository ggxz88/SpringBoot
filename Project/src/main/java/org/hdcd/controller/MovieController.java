...
public class MovieController {
	...
	public ResponseEntity<byte[]> downloadFile1(Integer movieNo, Authentication authentication) throws Exception {
		logger.info("Download1");
		
		InputStream in = null;
		ResponseEntity<byte[]> entity = null;
		
		String fullName = movieService.getPoster(movieNo);
	...
	public ResponseEntity<byte[]> downloadFile2(Integer movieNo, Authentication authentication) throws Exception {
		logger.info("Download2");
		
		InputStream in = null;
		ResponseEntity<byte[]> entity = null;
		
		String fullName = movieService.getStill1(movieNo);
	...
	public ResponseEntity<byte[]> downloadFile3(Integer movieNo, Authentication authentication) throws Exception {
		logger.info("Download3");
		
		InputStream in = null;
		ResponseEntity<byte[]> entity = null;
		
		String fullName = movieService.getStill2(movieNo);
	...
	public ResponseEntity<byte[]> downloadFile4(Integer movieNo, Authentication authentication) throws Exception {
		logger.info("Download4");
		
		InputStream in = null;
		ResponseEntity<byte[]> entity = null;
		
		String fullName = movieService.getStill3(movieNo);
	...
	public ResponseEntity<byte[]> downloadFile5(Integer movieNo, Authentication authentication) throws Exception {
		logger.info("Download5");
		
		InputStream in = null;
		ResponseEntity<byte[]> entity = null;
		
		String fullName = movieService.getStill4(movieNo);
